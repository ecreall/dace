...
from dace.model.principal import Group
from dace.util import get_root, find_service
...
def get_users_with_role(role=None, root=None):
    ...
    opts[u'reftype'] = 'Role'
    users = list(set([r.source for r in
                      find_relations(normalized_role[1], opts).all()]))
